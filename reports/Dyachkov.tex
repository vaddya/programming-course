...
\begin{enumerate}
	...
	Пользователю предлагается ввести имя файла, откуда должен получить исходные данные и имя файла, куда будет происходить печать результата, после чего вызывается функция для опредления победителя и вывод результата в указанный файл.
